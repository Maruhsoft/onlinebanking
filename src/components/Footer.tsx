...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Facebook size={20} />, url: 'https://facebook.com/firstbank', label: 'Facebook' },
    { icon: <Twitter size={20} />, url: 'https://twitter.com/firstbank', label: 'Twitter' },
    { icon: <LinkedIn size={20} />, url: 'https://linkedin.com/company/firstbank', label: 'LinkedIn' },
    { icon: <Instagram size={20} />, url: 'https://instagram.com/firstbank', label: 'Instagram' },
    { icon: <Youtube size={20} />, url: 'https://youtube.com/firstbank', label: 'YouTube' }
  ];
