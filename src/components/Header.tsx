...
import { Search, ChevronDown, Menu, X, Home, CreditCard, Building2, Smartphone, PiggyBank, HelpCircle, Lock } from 'lucide-react';
          ...
          <div className="flex items-center space-x-4">
            <form onSubmit={handleSearch} className="hidden lg:flex items-center">
              <input
                ...
                className="w-64 px-4 py-1 border border-gray-300 rounded-l focus:outline-none focus:ring-2 focus:ring-blue-900 focus:border-transparent"
              />
              <button
                type="submit"
                className="px-4 py-1 bg-blue-900 text-white rounded-r hover:bg-blue-800 transition-colors duration-200"
              >
                <Search className="w-5 h-5" />
              </button>
            </form>
            <Link
              to="/digital-banking/login"
              className="bg-yellow-500 text-blue-900 px-4 py-2 rounded font-medium hover:bg-yellow-400 transition-colors duration-200 shadow-sm"
            >
              Online Banking
            </Link>
            <button 
          ...
          <div className="px-4 py-3 border-t border-gray-200">
            <form onSubmit={handleSearch} className="flex items-center">
              <input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="flex-1 px-3 py-1 border border-gray-300 rounded-l focus:outline-none focus:ring-2 focus:ring-blue-900 focus:border-transparent"
              />
              <button
                type="submit"
                className="px-4 py-1 bg-blue-900 text-white rounded-r hover:bg-blue-800 transition-colors duration-200"
