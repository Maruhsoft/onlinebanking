        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-6">
            ...
            <a
              ...
              className="flex items-center px-6 py-2.5 bg-yellow-500 text-blue-900 rounded-md font-medium hover:bg-yellow-400 transition-all duration-200 shadow-sm hover:shadow-md"
            >
