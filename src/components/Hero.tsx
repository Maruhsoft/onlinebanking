        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="px-6 py-3 bg-yellow-500 text-blue-900 rounded-md hover:bg-yellow-400 transition-colors duration-200 font-semibold shadow-lg flex items-center">
                Open Account <ArrowRight className="ml-2" size={20} />
              </button>
              <button className="px-6 py-3 border-2 border-white rounded-md hover:bg-white hover:text-blue-900 transition-colors duration-200 font-semibold">
                Learn More
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="flex items-center justify-center">
              <img src="https://upload.wikimedia.org/wikipedia/commons/5/5c/Bank_of_England.svg" alt="Bank of England" className="h-12 opacity-75" />
            </div>
            <div className="flex items-center justify-center">
              <img src="https://upload.wikimedia.org/wikipedia/commons/8/8f/Visa_Inc._logo.svg" alt="Visa" className="h-8 opacity-75" />
            </div>
            <div className="flex items-center justify-center">
              <img src="https://upload.wikimedia.org/wikipedia/commons/2/2a/Mastercard-logo.svg" alt="Mastercard" className="h-8 opacity-75" />
            </div>
            <div className="flex items-center justify-center">
              <img src="https://upload.wikimedia.org/wikipedia/commons/4/46/Bitcoin.svg" alt="Bitcoin" className="h-8 opacity-75" />
            </div>
          </div>
        </div>
      </div>
